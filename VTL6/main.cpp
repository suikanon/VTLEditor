	...
	switch(M)
	{
		...
		case WM_COMMAND:
			switch(LOWORD(W))
			{
				...
				break;
				case IDB_MAKE_GOLD: //gold
				{
					if(HIWORD(W)==BN_CLICKED)
					{
						int ii;
						for(ii=IDT_ABIL_ATKP;ii<gi_lastAbility;ii+=2)
							if (ii == IDT_ABIL_GOAL) //Nerf Goalkeeping to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));
							else if (ii == IDT_ABIL_CATC) //Nerf Catching to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));
							else if (ii == IDT_ABIL_CLEA) //Nerf Clearing to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));
							else if (ii == IDT_ABIL_REFL) //Nerf Reflexes to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));
							else if (ii == IDT_ABIL_COVE) //Nerf Coverage to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));														
							else SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("99"));
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_FORM, WM_SETTEXT, 0, (LPARAM)_T("8")); //Form
						SendDlgItemMessage(ghw_main, IDT_PLAY_HGT, WM_SETTEXT, 0, (LPARAM)_T("181")); //height
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_INJU, WM_SETTEXT, 0, (LPARAM)_T("1")); //Injury resistance
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKUS, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot usage
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKAC, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot accuracy
					}
					//SendDlgItemMessage(ghw_tab1, IDS_PLAY_CF+ii, TBM_SETPOS, (WPARAM)TRUE, (LPARAM)gplayers[p_ind].play_pos[ii])
				}
				break;
				case IDB_MAKE_SILV: //silver
				{
					if(HIWORD(W)==BN_CLICKED)
					{
						int ii;
						for(ii=IDT_ABIL_ATKP;ii<gi_lastAbility;ii+=2)
							if (ii == IDT_ABIL_GOAL) //Nerf Goalkeeping to 40
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));
							else if (ii == IDT_ABIL_ATKP) //Buff attacking prowess to 98
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("98"));
							else if (ii == IDT_ABIL_FINI) //Buff finishing to 98
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("98"));
							else if (ii == IDT_ABIL_SWER) //Buff swerve to 98
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("98"));
							else if (ii == IDT_ABIL_DEFP) //Nerf Defensive prowess to 88
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("91"));	
							else if (ii == IDT_ABIL_BWIN) //Nerf Ball winning to 88
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("91"));
							else if (ii == IDT_ABIL_SPED) //Buff Speed to 95
								...
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("40"));														
							else SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("93"));
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_FORM, WM_SETTEXT, 0, (LPARAM)_T("6")); //Form
						SendDlgItemMessage(ghw_main, IDT_PLAY_HGT, WM_SETTEXT, 0, (LPARAM)_T("181")); //height
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_INJU, WM_SETTEXT, 0, (LPARAM)_T("1")); //Injury resistance
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKUS, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot usage
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKAC, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot accuracy
				...
				break;
				case IDB_MAKE_REGU: //regular
				{
					if(HIWORD(W)==BN_CLICKED)
					{
						int ii;
						for(ii=IDT_ABIL_ATKP;ii<gi_lastAbility;ii+=2)
							if (ii == IDT_ABIL_ATKP) //Buff atk Prowess to 94
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("94"));
							else if (ii == IDT_ABIL_BCON) //Buff Ball controll to 89
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("89"));
							else if (ii == IDT_ABIL_DRIB) //Buff Dribbling to 89
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("89"));
							else if (ii == IDT_ABIL_LOWP) //Buff Low pass to 85
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("85"));
							else if (ii == IDT_ABIL_LOFT) //Buff Lofted pass to 85
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("85"));	
							else if (ii == IDT_ABIL_FINI) //Buff finishing to 97
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("97"));
							else if (ii == IDT_ABIL_SWER) //Buff swerve to 97
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("97"));	
							else if (ii == IDT_ABIL_HEAD) //Buff Header to 82
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("82"));
							else if (ii == IDT_ABIL_DEFP) //Nerf Defensive prowess to 72
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("72"));
							else if (ii == IDT_ABIL_BWIN) //Nerf Ball winning to 66
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("66"));
							else if (ii == IDT_ABIL_KPOW) //Buff kicking power to 85
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("85"));
							else if (ii == IDT_ABIL_SPED) //Buff Speed to 82
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("82"));
							else if (ii == IDT_ABIL_EXPL) //Nerf Explosive power to 72
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("72"));
							else if (ii == IDT_ABIL_BODB) //Buff Unwavering balance to 86
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("86"));	
							else if (ii == IDT_ABIL_PHCO) //Nerf Physical contact to 73
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("73"));
							else if (ii == IDT_ABIL_STAM) //Nerf Stamina to 66
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("66"));	
							else if (ii == IDT_ABIL_CATC) //Nerf catching to 72
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("72"));
							else if (ii == IDT_ABIL_REFL) //Nerf Reflexes to 72
								SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("72"));								
							else SendDlgItemMessage(ghw_tab1, ii, WM_SETTEXT, 0, (LPARAM)_T("77"));
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_FORM, WM_SETTEXT, 0, (LPARAM)_T("2")); //Form
						SendDlgItemMessage(ghw_main, IDT_PLAY_HGT, WM_SETTEXT, 0, (LPARAM)_T("181")); //height
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_INJU, WM_SETTEXT, 0, (LPARAM)_T("1")); //Injury resistance
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKUS, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot usage
						SendDlgItemMessage(ghw_tab1, IDT_ABIL_WKAC, WM_SETTEXT, 0, (LPARAM)_T("4")); //Weak foot accuracy
